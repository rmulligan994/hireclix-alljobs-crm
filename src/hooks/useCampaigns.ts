...
export const useOrgCampaigns = (requireOrgSharedCampaigns: boolean) => {
  return useQuery({
    queryKey: ['campaigns', 'org', requireOrgSharedCampaigns],
    queryFn: () => campaignService.getOrgCampaigns({ requireOrgSharedCampaigns }),
  });
};
