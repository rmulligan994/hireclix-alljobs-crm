-- Case-insensitive sidebar "Skills" / tag filter. Must stay aligned with
-- 20260415120000_candidate_search_performance.sql (search_vector JOIN), not the older substring RPC.
